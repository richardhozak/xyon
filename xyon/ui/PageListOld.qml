...
Item {
	...
	property bool shadowOverlayEnabled: true
	property color shadowOverlayColor: "black"

	readonly property alias rowX: row.x
	readonly property alias rowWidth: row.width

	//property url backgroudSource
	...
	Image {
		...
		Component.onCompleted: {
			console.log("asdasdasdas", root.height, root.width)
		}
	}
	...
	Component.onCompleted: {
		...
		console.log("asdasdasdas222", root.height, root.width)
	}
	...
	/*Image {
		id: backgroundImage
		source: "/images/scrolling_background.png"
		//x: row.x
		//anchors.fill: parent
	}*/
	...
	Row {
		...
		onXChanged: console.log("x", width, x)
		...
		Repeater {
			...
			delegate: Item {
				...
				Rectangle {
					anchors.fill: parent
					color: root.shadowOverlayColor
					opacity: 0
					visible: opacity != 0 && root.shadowOverlayEnabled
